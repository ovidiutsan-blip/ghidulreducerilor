...
export const THEME_HUBS: ThemeHub[] = [
  ...
  },
  {
    ...
    storeSlugs: ['springfarma'],
    dealCategories: ['farmacie-sanatate'],
    faq: [
      {
  ...
  },
  {
    ...
    storeSlugs: ['casanewconcept', 'case-smart', 'emobili', 'hotpick', 'mathaus', 'mindblower', 'novodoors', 'scule365', 'somnart', 'startdecor', 'techstar'],
